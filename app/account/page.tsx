...
import { logoutUser, getSupabaseClient } from "../../lib/nolera-auth"
...
export default function AccountPage() {
  ...
  if (!user) {
    return (
      <main
        dir="rtl"
        className="min-h-screen bg-slate-100 p-6 text-center"
      >
  ...
  return (
    <main
      dir="rtl"
      className="min-h-screen bg-[#f5f7fb] p-5"
    >
      <div className="mx-auto max-w-6xl">
        ...
        <section className="mt-5 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <Link
            href="/store"
            className="rounded-3xl bg-white p-5 font-black shadow-sm"
          >
            🛍️ المتجر
          </Link>
